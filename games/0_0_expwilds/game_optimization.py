        ...
        self.game_config.opt_params = {
            "base": {
                "conditions": {
                    ...
                    "freegame": ConstructConditions(
                        rtp=0.367, hr=200, search_conditions={"symbol": "scatter"}
                    ).return_dict(),
            ...
            "bonus": {
                "conditions": {
                    ...
                    "freegame": ConstructConditions(rtp=0.957, hr="x").return_dict(),
                },
                "scaling": ConstructScaling(
                    [
                        {
            ...
            "superspin": {
                "conditions": {
                    "wincap": ConstructConditions(
                        rtp=0.01, av_win=wincaps["superspin"], search_conditions=wincaps["superspin"]
                    ).return_dict(),
                    "0": ConstructConditions(rtp=0, av_win=0, search_conditions=0).return_dict(),
                    "basegame": ConstructConditions(hr=1.9, rtp=0.957).return_dict(),
                },
                "scaling": ConstructScaling(
                    [
                        {
